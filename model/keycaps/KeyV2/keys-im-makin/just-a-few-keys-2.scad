...
for(y = [0:len(legends_row_2)-1]){
    if(len(legends_row_2[y]) == 2){
        translate_u(y+1,-3) cherry_row(4) legend(legends_row_2[y][0], position=[0,-0.8], size=4) front_legend(legends_row_2[y][1], position=[0,0.8], size=3.5) key(
